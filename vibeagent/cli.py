...
from .skills import ArxivSkill, LLMSkill
...
def search(
    ...
    config_path: Path = typer.Option(
        "config/agent_config.json", "--config", "-c", help="Path to config file"
    ),
    ...
    arxiv_skill = ArxivSkill(
        max_results=max_results, months_back=config.config["skills"]["arxiv"]["months_back"]
    )
    llm_skill = LLMSkill(
